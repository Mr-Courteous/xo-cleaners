...
// Define the full list of roles from the spreadsheet
const SYSTEM_ROLES = [
  { value: 'admin', label: 'Platform Admin' },
  { value: 'store_owner', label: 'Store Owner' },
  { value: 'store_admin', label: 'Store Admin' },
  { value: 'store_manager', label: 'Store Manager' },
  { value: 'cashier', label: 'Cashier / Associate' },
  { value: 'laundry_staff', label: 'Laundry Staff / Operator' },
  { value: 'driver', label: 'Driver / Delivery Agent' },
...
      setShowForm(false);
      await refetch();
      alert(`User ${created?.username || created?.id} created successfully!`);
    } catch (err: any) {
