  ...
  return `
    <div style="width:58mm; margin:0 auto; font-family: 'Arial', 'Helvetica', sans-serif; font-weight: 700; color:#000; background: white; padding: 2px;">
      ...
      <div style="text-align:center; margin-bottom: 10px;">
        <div style="font-size:15pt; font-weight:900; text-transform:uppercase; margin-bottom:4px; line-height:1;">
      ...
      <div style="margin-top:12px; text-align:center; font-size:12pt; font-weight:900; text-transform: uppercase;">
