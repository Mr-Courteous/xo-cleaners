...
export function renderReceiptHtml(ticket: Ticket) {
  ...
  const itemsList = items.map(item =>
    `<div style="display:flex;justify-content:space-between;margin:4px 0;font-size:10pt;">` +
  ...
  return `
    <div style="width:55mm;margin:0 auto;font-family:'Courier New', Courier, monospace;color:#111;padding:8px;">
      ...
      <div style="display:flex;justify-content:space-between;font-size:10pt;margin-bottom:6px;">
      ...
      <div style="margin-top:8px;text-align:center;font-family:'Courier New', Courier, monospace;font-size:12pt;">
